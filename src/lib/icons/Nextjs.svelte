	...
	><defs
		...
		><linearGradient id="logosNextjsIcon1" x1="50%" x2="49.953%" y1="0%" y2="73.438%"
			><stop offset="0%" stop-color="#fff"></stop><stop
				...
				stop-opacity={0}
			></stop></linearGradient
		><circle id="logosNextjsIcon2" cx={128} cy={128} r={128}></circle></defs
	><mask id="logosNextjsIcon3" fill="#fff"><use href="#logosNextjsIcon2"></use></mask><g
		...
		></path><path fill="url(#logosNextjsIcon1)" d="M163.556 76.8h17.067v102.4h-17.067z"></path></g
	></svg
>
