<script lang="ts">
	import { ICON_SIZE, type IconProps } from ".";

	let { size = ICON_SIZE }: IconProps = $props();
</script>

<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 256 223"
	><defs
		><linearGradient id="logosChromeWebStore0" x1="0%" x2="100%" y1="50%" y2="50%"
			><stop offset="0%" stop-color="#d93025"></stop><stop offset="100%" stop-color="#ea4335"
			></stop></linearGradient
		><linearGradient id="logosChromeWebStore1" x1="74.943%" x2="19.813%" y1="95.826%" y2="-4.161%"
			><stop offset="0%" stop-color="#1e8e3e"></stop><stop offset="100%" stop-color="#34a853"
			></stop></linearGradient
		><linearGradient id="logosChromeWebStore2" x1="59.898%" x2="21.416%" y1="-.134%" y2="99.86%"
			><stop offset="0%" stop-color="#fbbc04"></stop><stop offset="100%" stop-color="#fcc934"
			></stop></linearGradient
		><path
	...
	><path
		fill="#f1f3f4"
		d="M255.983 0H0v204.837c0 9.633 7.814 17.464 17.464 17.464h221.072c9.633 0 17.464-7.814 17.464-17.464z"
	></path><path fill="#e8eaed" d="M0 0h255.983v111.74H0z"></path><path
		fill="#fff"
	...
	></path><mask id="logosChromeWebStore4" fill="#fff"><use href="#logosChromeWebStore3"></use></mask
	><g mask="url(#logosChromeWebStore4)"
		><g transform="translate(17.455 94.293)"
			><path
				fill="url(#logosChromeWebStore0)"
			...
			></path><ellipse cx={110.536} cy={110.544} fill="#f1f3f4" rx={55.255} ry={55.272}
			></ellipse><ellipse cx={110.536} cy={110.544} fill="#1a73e8" rx={44.898} ry={44.915}
			></ellipse></g
		></g
